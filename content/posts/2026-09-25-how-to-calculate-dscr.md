---
title: "How to Calculate DSCR Yourself Before You Write the Offer"
slug: how-to-calculate-dscr
description: "The formula is one line. Everything that makes it hard is on the bottom, where taxes, insurance, association dues and rent loss coverage live. Here is how to run it accurately on an Arizona property in ten minutes."
date: 2026-09-25
city: Scottsdale
borrowerType: Investor
program: DSCR Calculation
motif: dscr
...
1. Get the actual lease and the likely market rent. Use the lower.
2. Price the loan at the note rate on the amount you will request.
3. Pull the assessor's tax figure and check for a pending reset.
4. Get a real insurance quote including six months of rent loss coverage.
5. Get the association dues in writing, including any special assessment.
6. Add the four. Divide the rent by the total.
7. Find your cell on the grid using your score, the loan size and the coverage.
...
Gross Rental Income divided by PITIA on an amortizing loan, or Gross Rental Income divided by ITIA on an interest only loan. It is qualified at the original note rate.

**Which rent figure is used?**
The lower of the executed lease agreement or the market rent from the appraisal. A higher lease can be used with evidence of receipt, supported by the three most recent consecutive months.

**Do HOA dues count in the calculation?**
Yes. The A in PITIA is assessments, and association dues sit fully in the denominator. In this market they are frequently what decides whether a file clears the ratio.

**Do I need rent loss insurance?**
Yes. Rent loss insurance is required on the subject property and must equal at least six months of local average monthly rents. Include it in your insurance quote before you calculate.

**What DSCR do I need?**
0.75x is eligible, and a No Ratio option exists with restrictions. Coverage of 1.00x or better unlocks the highest leverage on the grid.

**Does interest only improve my ratio?**
Yes, because the calculation uses ITIA and removes principal from the denominator. It requires a 700 minimum FICO, caps leverage at 75% at 1.00x coverage or 70% at 0.75x, and is not permissible on No Ratio.

## Related reading

- [DSCR and investor property loans](/dscr-investor-loans/), the full index for this topic
- [DSCR Loan FAQ: The Questions Investors Ask Before Their First One](/blog/dscr-loan-faq/)
- [No-Ratio DSCR Loans: Financing a Property That Does Not Cover Its Payment](/blog/no-ratio-dscr-loans/)
- [DSCR on Duplexes, Triplexes and Fourplexes: How the Ratio Changes With Unit Count](/blog/dscr-2-4-unit-properties/)
