---
title: "Self-Employed Jumbo Loans: Buying Above Conforming Without Tax Returns"
slug: self-employed-jumbo-loans
description: "Non-QM jumbo runs to three and a half million dollars on bank statements, with no mortgage insurance at any leverage. The constraint is rarely the loan size. It is the ratio ceiling and the reserve requirement that come with it."
date: 2026-09-25
city: Scottsdale
borrowerType: Self-Employed
program: Self-Employed Jumbo
motif: statements
...
**Expanded:** interest only eligible, minimum **700 FICO**, maximum **85% loan-to-value**.
**Premium:** interest only eligible, minimum **700 FICO**, maximum **80% loan-to-value**.
**Standard:** interest only **not permissible**.
...
**How large can a self-employed non-QM loan be?**
$3.5 million on the Expanded tier, $3.0 million on Premium and $2.0 million on Standard, with maximum leverage of 90%, 90% and 85% respectively.

**Is there mortgage insurance on a non-QM jumbo?**
No. Mortgage insurance is not required on any loan in the series, regardless of loan-to-value, which is a real advantage over agency financing above eighty percent.

**What is the maximum debt-to-income on a jumbo non-QM loan?**
Up to 55% on Expanded, but only with a 700 or greater FICO, a maximum 80% loan-to-value, primary residence only, no first time homebuyers and 1.5x residual income. Premium allows up to 50% and Standard up to 45%.

**What is the residual income requirement?**
For a higher priced mortgage loan or any file above 43% debt-to-income: $1,500 monthly residual for a one person household, $2,500 for two, plus $150 for each additional member.

**Can I get an interest only jumbo?**
On Expanded to 85% loan-to-value and Premium to 80%, both requiring a minimum 700 FICO. Interest only is not permissible on the Standard tier.

**How many reserves do I need on a jumbo purchase?**
Six months on Expanded, three months on Premium and Standard. On a refinance, cash-out proceeds can be used as reserves.

## Related reading

- [Self-employed and business owner home loans](/self-employed-home-loans/), the full index for this topic
- [One Late Payment: How Housing History Moves You Between Non-QM Tiers](/blog/housing-history-tiers-non-qm/)
- [The Expense Factor Table: Why Your Industry Decides Your Qualifying Income](/blog/expense-factor-by-business-type/)
- [Self-Employed Cash-Out Refinance: Pulling Equity Without Two Years of Returns](/blog/self-employed-cash-out-refinance/)
