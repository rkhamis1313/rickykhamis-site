...
Get the HOA questionnaire, budget, reserve study, master insurance certificate, litigation disclosure, meeting minutes and the owner-occupancy percentage **before you remove contingencies.** The full review is in [Scottsdale Luxury Condo Financing](/blog/scottsdale-luxury-condo-project-approval/).
...
1. **A signed long-term lease with documented receipt**, subject to a vacancy factor.
2. **Documented operating history on the subject property:** Schedule E plus a full year of statements.
3. **A market rent appraisal, Form 1007**, which in most cases opines on **long-term** rent, not nightly revenue.

Not used: your pro forma, a projection tool's estimate, an advertised nightly rate, or the seller's unverified claim.

**The Waterfront is walkable to Old Town and Fashion Square**, which is precisely why nightly rental is what many buyers here are planning. Lenders discount projected short-term rental income severely or refuse it entirely, and Scottsdale income is seasonal and event-driven on top of that. See [Spring Training, the Open, and Your Loan](/blog/scottsdale-short-term-rental-income-loan/).
...
**DSCR**, the property carries itself. **Bank statement**, deposits with an expense factor applied, noting that transfers between your own accounts are stripped, covered in [Bank Statement Loans in DC Ranch](/blog/bank-statement-dc-ranch-scottsdale/). **Asset depletion**, qualifying income from verified liquid assets. **No-ratio**, no debt-to-income test at all, which is frequently right for an investor holding multiple properties whose deducted-down return misrepresents them.
