---
title: "DSCR on Duplexes, Triplexes and Fourplexes: How the Ratio Changes With Unit Count"
slug: dscr-2-4-unit-properties
description: "Multi-unit properties are capped at 75% leverage on DSCR regardless of how strong the coverage is. In exchange you get a rent roll that does not go to zero when one tenant leaves, which is a better trade than most investors realise."
date: 2026-09-25
city: Scottsdale
borrowerType: Investor
program: Multi-Unit DSCR
motif: dscr
...
1. Get the actual rent roll with lease copies, not a summary.
2. Identify which units are above market and gather three months of payment evidence for each.
3. Get a real insurance quote on the property including six months of rent loss coverage.
4. Build PITIA and divide the accepted rent roll by it.
5. Plan the down payment at 75%, and at 70% if there is any chance of a declining market flag.

## Common questions

**What is the maximum leverage on a 2-4 unit DSCR loan?**
75% loan-to-value and combined loan-to-value. The cap is set by property type and does not improve with better coverage, a higher score or a smaller loan.

**Is a fourplex better than a single family rental?**
On vacancy risk, usually. A single family rental produces no income when the tenant leaves, while a fourplex loses a quarter of its rent roll. The cost is five points of leverage.

**How is DSCR calculated on multiple units?**
The same formula across the whole rent roll: gross rental income divided by PITIA, using the lower of each executed lease or the appraisal's market rent for each unit.

**Can I use an above-market lease on one unit?**
Yes, with sufficient evidence of receipt, supported by the three most recent consecutive months of payments.

**How much rent loss insurance do I need on a fourplex?**
At least six months of local average monthly rents, which on a multi-unit property is a substantially larger figure than on a single family house. Get a real quote before calculating coverage.

## Related reading

- [DSCR and investor property loans](/dscr-investor-loans/), the full index for this topic
- [How to Calculate DSCR Yourself Before You Write the Offer](/blog/how-to-calculate-dscr/)
- [DSCR Loan FAQ: The Questions Investors Ask Before Their First One](/blog/dscr-loan-faq/)
- [Building a Rental Portfolio on DSCR: Sequencing Loans So the Fourth One Still Closes](/blog/building-a-rental-portfolio-dscr/)
