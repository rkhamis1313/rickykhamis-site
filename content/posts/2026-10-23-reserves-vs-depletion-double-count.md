---
title: "The Double Count Problem: Why Money Used for Closing Cannot Also Be Income"
slug: reserves-vs-depletion-double-count
description: "One sentence in the guidelines removes your down payment from the portfolio before the income calculation runs. Understanding it changes which account you should pull closing funds from, and it is worth thousands a month in qualifying income."
date: 2026-10-23
city: Scottsdale
borrowerType: Asset Based
program: Asset Based Underwriting
motif: assets
...
1. Decide the purchase price and the total cash needed to close.
2. Model funding it from each account type and see what each does to qualifying assets.
3. Take the comparison to your accountant, with the tax cost of each option attached.
4. Choose the source, then liquidate and document it properly.
5. Recalculate the 125% test on the post-closing figure.
6. Then, and only then, decide how much house the number supports.

Most borrowers do these in reverse and find out in underwriting that the income they assumed does not exist.

## Common questions

**Can my down payment also count as income on an asset depletion loan?**
No. Assets used for down payment or costs to close must be excluded from the balance before the portfolio is analyzed for income qualification.

**Does it matter which account I use for closing costs?**
Yes, considerably. Checking counts at 100%, stocks, bonds and mutual funds at 80%, and vested retirement at 70%, so withdrawing from a more heavily discounted account preserves more qualifying assets.

**Should I take my down payment from my IRA?**
It produces the best qualifying income and frequently the worst tax outcome. Run the comparison with your accountant. Funding from a brokerage account is often the practical middle ground.

**Do I need reserves on top of the down payment?**
No. Reserves are not required on the asset depletion and asset qualifier programs. The 125% asset requirement does that work instead.

**What is the 125% requirement measured against?**
On asset depletion, qualifying assets of at least 125% of the original loan amount, or $1 million, whichever is less. On asset qualifier, total post-closing assets of at least 125% of the original loan amount.
